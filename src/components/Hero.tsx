      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <Button variant="dual" size="xl" className="group">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-2xl mx-auto">
            <div className="text-center group cursor-default hover:scale-105 transition-bounce">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-purple/20 rounded-full mb-4 group-hover:bg-purple/30 transition-smooth">
